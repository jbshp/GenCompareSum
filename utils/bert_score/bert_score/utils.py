...
def get_model(model_type, num_layers=None, all_layers=None):
...
def get_tokenizer(model_type, use_fast=False):
    ...
    if LooseVersion(trans_version) >= LooseVersion("4.0.0"):
        ...
        if tokenizer.model_max_length > 10000000: # fix for pubmed and scibert models which don't have length set correctly
